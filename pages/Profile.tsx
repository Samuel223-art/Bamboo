  ...
  return (
    <div className="max-w-3xl mx-auto space-y-4 animate-fade-in">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-3">
        <div>
          <h1 className="text-xl font-black text-brand-900 dark:text-white tracking-tight">Profile</h1>
          <p className="text-xs text-brand-600 dark:text-brand-400 font-bold uppercase tracking-wider">Account Identity</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <Card className="p-6 flex flex-col items-center text-center shadow-md border-brand-50">
                ...
                <div className="flex flex-col gap-2 w-full">
                    <div className="flex items-center justify-between p-2.5 bg-brand-50 dark:bg-brand-900/20 rounded-lg border border-brand-100 dark:border-brand-800">
                        <span className="text-[9px] font-black uppercase text-brand-400">KYC Status</span>
        ...
        <div className="lg:col-span-2 space-y-4">
            <Card className="p-6 shadow-md border-brand-50">
                <h3 className="text-sm font-black text-brand-900 dark:text-white mb-6 uppercase tracking-widest border-b border-brand-50 dark:border-brand-800 pb-2">Information</h3>
